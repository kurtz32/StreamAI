...
const Hero: React.FC<HeroProps> = ({ movie, onPlay, onMoreInfo }) => {
  ...
  return (
    <div className="relative h-[55vh] sm:h-[65vh] md:h-[85vh] w-full">
      {/* Background Image */}
      ...
      {/* Content */}
      <div className="absolute bottom-16 sm:bottom-24 md:top-[30%] left-4 sm:left-8 md:left-12 max-w-[90%] sm:max-w-lg md:max-w-2xl space-y-3 md:space-y-5">
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-200 drop-shadow-md line-clamp-3 md:line-clamp-4 max-w-full md:max-w-[80%] leading-relaxed">
          {movie.description}
        </p>
